...
class AssertionEngine:
    ...
    def evaluate_expression(self, expression: str, context: Optional[Dict[str, Any]] = None) -> AssertionResult:
        """
    ...
    def assert_expression(self, expression: str, message: Optional[str] = None, 
                         context: Optional[Dict[str, Any]] = None) -> AssertionResult:
        """
...
class ResponseValidator:
    ...
    def validate_response(self, response: Dict[str, Any], expectations: Dict[str, Any]) -> AssertionResult:
        """
        ...
        if 'status' in expectations:
            ...
            if actual_status != expected_status:
                failures.append(f"Status code mismatch: expected {expected_status}, got {actual_status}")
        ...
        if 'headers' in expectations:
            ...
            for header_name, expected_value in expectations['headers'].items():
                ...
                if actual_value is None:
                    ...
                    failures.append(f"Header '{header_name}': expected to contain '{expected_value}', got '{actual_value}'")
                elif not isinstance(expected_value, str) and actual_value != expected_value:
                    failures.append(f"Header '{header_name}': expected {expected_value}, got '{actual_value}'")
        ...
        if 'body_contains' in expectations:
            ...
            for pattern in patterns:
                if pattern not in str(body):
                    failures.append(f"Body does not contain expected pattern: '{pattern}'")
        ...
        if 'max_response_time' in expectations:
            ...
            if actual_time > max_time:
                failures.append(f"Response time {actual_time}ms exceeded maximum {max_time}ms")
