...
class YAMLParser:
    ...
    def _parse_test_definition(self, data: Dict[str, Any], file_path: Path) -> TestDefinition:
    ...
    def _expand_shared_step(self, step_data: Dict[str, Any]) -> List[TestStep]:
        ...
        for step in shared_step.steps:
            ...
            expanded_step = TestStep(
                action=step.action,
                parameters=self._substitute_parameters(step.parameters, step_parameters)
            )
            expanded_steps.append(expanded_step)
        
        return expanded_steps
    
    def _substitute_parameters(self, original_params: Dict[str, Any], substitutions: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _detect_and_convert_recorder_format(self, data: Dict[str, Any], file_path: Path) -> Dict[str, Any]:
