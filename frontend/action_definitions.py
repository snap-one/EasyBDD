    ...
    "browser.click": {
        ...
        "parameters": {
            ...
            "role": {
                ...
                "required": False,
                "label": "ARIA Role",
                "options": ["button", "link", "checkbox", "radio", "textbox", "tab", "menuitem"],
    ...
    "browser.press": {
        ...
        "parameters": {
            "key": {
                ...
                "required": True,
                "label": "Key",
                "options": ["Enter", "Escape", "Tab", "Backspace", "Delete", "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight", "Space", "PageUp", "PageDown", "Home", "End"],
                "help": "Key to press"
            },
            "selector": {
                "type": "text",
...
def validate_action_parameters(action_id: str, params: Dict[str, Any]) -> tuple[bool, List[str]]:
