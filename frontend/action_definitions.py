...
ACTION_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    # ---- Data (declarative alternatives to eval.exec) ----
    "list.pick": {
        "category": "Data",
        "label": "Pick from List",
        "description": "Get one item from a list variable by index",
        "icon": "📌",
        "parameters": {
            "from_var": {
                "type": "text",
                "required": True,
                "label": "List Variable",
                "placeholder": "firmware_files",
                "help": "Name of the list-valued variable to index into",
            },
            "index": {
                "type": "number",
                "required": False,
                "label": "Index",
                "default": 0,
                "help": "Position to pick (0 = first, -1 = last, -2 = second-to-last, ...)",
            },
            "store_as": {
                "type": "text",
                "required": True,
                "label": "Variable Name",
                "placeholder": "upgrade_file",
                "help": "Store the picked item in this variable",
            },
        },
    },
    "text.replace": {
        "category": "Data",
        "label": "Replace Text",
        "description": "Replace a substring (or regex match) in a value",
        "icon": "🔤",
        "parameters": {
            "value": {
                "type": "text",
                ...
                "label": "Text",
                "placeholder": "${upgrade_file}",
                "help": "Text to search — usually a ${variable}",
            },
            "find": {
                "type": "text",
                "required": True,
                "label": "Find",
                "placeholder": "https://",
                "help": "Substring to find, or a regex pattern if Regex is checked",
            },
            "replace_with": {
                "type": "text",
                "required": False,
                "label": "Replace With",
                "placeholder": "http://",
                "help": "Replacement text (default: empty — removes the match)",
            },
            "regex": {
                "type": "boolean",
                "required": False,
                "label": "Regex",
                "default": False,
                "help": "Treat Find as a regex pattern instead of a literal substring",
            },
            "store_as": {
                "type": "text",
                "required": True,
                "label": "Variable Name",
                "placeholder": "upgrade_file",
                "help": "Store the result in this variable",
            },
        },
    },
    "text.regex_extract": {
        ...
        "description": "Pull a regex match (or capture group) out of a value",
        "icon": "🔍",
        "parameters": {
            "value": {
                "type": "text",
            ...
            "group": {
                ...
                "label": "Capture Group",
                "default": 0,
                "help": "Which group to extract (0 = whole match, 1 = first parentheses, ...)",
            },
            "default": {
                "type": "text",
                "required": False,
                "label": "Default",
                "placeholder": "",
                "help": "Value to store if the pattern doesn't match (default: empty string)",
            },
            "store_as": {
                "type": "text",
                "required": True,
                "label": "Variable Name",
                "placeholder": "fw_upgrade_version",
                "help": "Store the extracted value in this variable",
            },
        },
    },
    "text.format": {
        "category": "Data",
        "label": "Format Text",
        "description": "Combine ${variables} into a new text value",
        "icon": "📝",
        "parameters": {
            "template": {
                "type": "text",
                "required": True,
                "label": "Template",
                "placeholder": "${upgrade_date}.${upgrade_body}",
                "help": "Text with ${variable} placeholders to combine",
            },
            "store_as": {
                "type": "text",
                "required": True,
                "label": "Variable Name",
                "placeholder": "fw_upgrade_version_final",
                "help": "Store the combined text in this variable",
            },
        },
    },
    "text.extract_version": {
        ...
        "description": "Pull a version number out of a URL, filename, or list of them",
        "icon": "🏷️",
        "parameters": {
            "from_var": {
                "type": "text",
                ...
                "label": "From Variable",
                "placeholder": "firmware_files",
                "help": "Variable to read from — a string, or a list (picks one entry by Index)",
            },
            "index": {
                "type": "number",
                "required": False,
                "label": "Index",
                "default": 0,
                "help": "When From Variable is a list: which entry to use (0 = first, -1 = last)",
            },
            "pattern": {
                "type": "text",
                "required": False,
                "label": "Pattern",
                "placeholder": "(\\d+\\.\\d+[\\.\\d]*)",
                "help": "Regex for the version (default matches dotted version numbers)",
            },
            "store_as": {
                "type": "text",
                "required": False,
                ...
                "help": "Store the extracted version in this variable",
            },
            "run_name": {
                "type": "text",
                "required": False,
                "label": "Run Name",
                "placeholder": "EASY_BDD: ${product} Smoke Test - ${firmware_version}",
                "help": "If set, renames the current TestRail run to this (after ${} substitution)",
            },
        },
    },
    "state.set": {
        "category": "Data",
        "label": "Set State",
        "description": "Store a literal value under a name, shared across steps",
        "icon": "💾",
        "parameters": {
            "key": {
                "type": "text",
                ...
                "help": "Name to store the value under",
            },
            "value": {
                "type": "text",
                "required": False,
    ...
    "state.get": {
        "category": "Data",
        "label": "Get State",
        "description": "Read back a value previously stored with Set State",
        "icon": "📤",
        "parameters": {
            "key": {
                "type": "text",
            ...
            "store_as": {
                ...
                "required": True,
                "label": "Variable Name",
                "help": "Store the value in this variable",
            },
        },
    },
    "state.clear": {
        "category": "Data",
        "label": "Clear State",
        "description": "Erase everything stored with Set State",
        "icon": "🗑️",
        "parameters": {},
    },
}
